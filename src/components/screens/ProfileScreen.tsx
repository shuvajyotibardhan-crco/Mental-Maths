...
export function ProfileScreen({ isAdmin = false, isSuperAdmin = false }: { isAdmin?: boolean; isSuperAdmin?: boolean }) {
  ...
  return (
    <div className="p-4 max-w-md mx-auto space-y-6">
      ...
      {/* Delete Account — hidden for any admin or super admin */}
      {!isAdmin && !isSuperAdmin && confirmingDelete ? (
